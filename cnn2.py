...
# Data loading params
tf.flags.DEFINE_float("dev_sample_percentage", .22, "Percentage of the training data to use for validation")
...
y = np.zeros((len(raw_labels), 2))
for i, label in enumerate(raw_labels):
    y[i][0] = raw_labels[i]
    y[i][1] = 1 - raw_labels[i]
